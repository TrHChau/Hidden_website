...
function Contents() {
  const { containerContent, boxFooter, boxCoupon, boxBtnDelete, boxEmptyCart, titleEmpty,boxBtnEmpty } = styles;
 ...
 const navigate = useNavigate();
  ...
  return (
    <>
      {listProductCart.length > 0 ? <div className={containerContent}>
        <div>
          <CartTable
